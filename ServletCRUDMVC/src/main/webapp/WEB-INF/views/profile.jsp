                            ...
                            <c:choose>
                                <c:when test="${not empty user.avatar}">
                                    <c:choose>
                                        ...
                                        <c:when test="${user.avatar.startsWith('uploads/')}">
                                            <c:set var="imgSrc" value="${pageContext.request.contextPath}/${user.avatar}" />
                                        </c:when>
                                        <c:otherwise>
                                            <c:set var="imgSrc" value="${pageContext.request.contextPath}/uploads/${user.avatar}" />
                                        </c:otherwise>
                                    </c:choose>
